      ...
      >
        ...
        <section aria-labelledby="evidence-heading" className="absolute left-[54px] top-[250px] w-[396px]">
          ...
          <div className="h-[148px] border-[3px] border-gray-400 rounded-xl px-6 flex items-center mb-6">
            <Link href="/presentation/15" onClick={(event) => event.stopPropagation()} onPointerDown={(event) => event.stopPropagation()} className="block underline decoration-gray-300 underline-offset-4 hover:decoration-black"><h3 className="text-[32px] font-bold leading-tight">8–9 months<br />profitable live results</h3><span className="text-lg text-gray-600">View Falcon results · Slide 15 →</span></Link>
          </div>
