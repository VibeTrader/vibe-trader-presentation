...
export default function TradingResultsSlide() {
  ...
  return (
    <div className="relative h-full w-full bg-white px-20 pt-16 text-black overflow-hidden">
      ...
      <div className="absolute bottom-8 left-20 flex gap-8 text-xl underline underline-offset-4"><Link href="/presentation/14">Back to FAQ</Link><Link href="/presentation/10">Back to investment slide</Link></div>
